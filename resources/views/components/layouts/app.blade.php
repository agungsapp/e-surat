								...
								<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
										<div class="app-brand demo">
												<a href="index.html" class="app-brand-link">
														...
														<span class="app-brand-text demo menu-text fw-bolder ms-2">SILANDES</span>
												</a>
										...
										<ul class="menu-inner py-1">
												...
												<li class="menu-item {{ Route::is('admin.penduduk') ? 'active' : '' }}">
												...
												<li class="menu-item {{ Route::is('admin.data-surat') ? 'active' : '' }}">
														<a href="{{ route('admin.data-surat') }}" class="menu-link">
																<i class="menu-icon tf-icons bx bx-home-circle"></i>
																<div data-i18n="Analytics">Data Surat Tersedia</div>
														</a>
												</li>
												<li class="menu-item {{ Route::is('admin.permohonan') ? 'active' : '' }}">
														<a href="{{ route('admin.permohonan') }}" class="menu-link">
																<i class="menu-icon tf-icons bx bx-home-circle"></i>
																<div data-i18n="Analytics">Data Permohonan</div>
														</a>
												</li>
												...
												<li class="menu-header small text-uppercase">
														<span class="menu-header-text">Management Content</span>
												</li>
												<li class="menu-item">
												...
												{{-- <li class="menu-item">
														<a href="javascript:void(0);" class="menu-link menu-toggle">
																...
																<div data-i18n="Account Settings">Manajemen Content</div>
														</a>
														<ul class="menu-sub">
																<li class="menu-item">
								...
								<div class="layout-page">
										...
										>
												...
												<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
														...
														<h3 class="pt-3">Sistem Pelayanan Surat Online - SILANDES</h3>
															</div>
															</div>
