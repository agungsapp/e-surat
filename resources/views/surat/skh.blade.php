...
<body>
		...
		<div class="bold center underline">SURAT KETERANGAN KEHILANGAN</div>
		...
		<div class="content">
				...
				Telah kehilangan <span class="bold" style="text-transform: capitalize;">{{ $data['Kehilangan'] }}</span>
				di sekitar <span class="bold" style="text-transform: capitalize;">{{ $data['LokasiKehilangan'] }}</span>,
				pada hari <span class="bold">{{ \Carbon\Carbon::parse($data['TanggalKehilangan'])->format('d F Y') }}</span>.
				<br><br>
