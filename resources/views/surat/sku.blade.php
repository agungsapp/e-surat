...
<head>
		...
		{{-- <link rel="stylesheet" href="{{ asset('surat/css/surat.css') }}" /> --}}
...
<body>
		...
		<div class="bold center underline">SURAT KETERANGAN USAHA</div>
		...
		<div class="content">
				...
				Yang bersangkutan benar warga tersebut dari penduduk Kampung Juku Batu Kecamatan Banjit Kabupaten Way Kanan dan
				memiliki usaha <span class="bold" style="text-transform: capitalize;">{{ $data['JenisUsaha'] }}</span>, yang
				berlokasi di Dusun {{ $penduduk->dusun }} Kampung Juku Batu
				Kecamatan Banjit Kabupaten Way Kanan.

				<br /><br />
				Demikianlah Surat Keterangan Usaha ini dibuat dengan sebenarnya, selanjutnya dapat dipergunakan sebagaimana
				mestinya.
		</div>
