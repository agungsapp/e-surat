...
<body>
		...
		<div class="bold center underline">SURAT KETERANGAN KEMATIAN</div>
		...
		<div class="content">
				...
				<table class="table">
						<tr>
								<td>Hari/Tanggal</td>
								<td style="font-weight: bold;">: {{ $data['TanggalKematian'] }}</td>
						</tr>
						<tr>
								<td>Pukul/Tempat</td>
								<td style="font-weight: bold;">: {{ $data['WaktuKematian'] }}, {{ $data['TempatKematian'] }}</td>
						</tr>
						<tr>
								<td>Tempat Pemakaman</td>
								<td style="font-weight: bold;">: {{ $data['TempatPemakaman'] }}</td>
						</tr>
